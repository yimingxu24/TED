...
def han_convert(dataset, attributed, supervised):
    ...
    new_node_file = open(f'{model_data_folder}/{node_file}','w', encoding='utf-8')
    with open(f'{ori_data_folder}/{node_file}','r', encoding='utf-8') as original_node_file:
        for line in original_node_file:
    ...
    new_link_file = open(f'{model_data_folder}/{link_file}','w', encoding='utf-8')
    with open(f'{ori_data_folder}/{link_file}','r', encoding='utf-8') as original_link_file:
        for line in original_link_file:
    ...
    with open(f'{ori_data_folder}/{info_file}','r', encoding='utf-8') as original_info_file:
        for line in original_info_file:
    ...
    config_file = open(f'{model_data_folder}/config.dat','w', encoding='utf-8')
    ...
    if supervised=='True':
        ...
        if dataset == 'T20H' or dataset == 'T15H':
            for i in range(5):
                label_file = 'label_TaxPayer' + str(5-i) + 'v' + str(5+i) + '.dat'
                new_label_file = open(f'{model_data_folder}/{label_file}','w', encoding='utf-8')
...
def ted_convert(dataset, attributed, supervised):
    
    ori_data_folder = f'{data_folder}/{dataset}'
    model_data_folder = f'{model_folder}/TED/data/{dataset}'
            
    print('TED: converting {}\'s node file for {} training!'.format(dataset, 'attributed' if attributed=='True' else 'unattributed'))
    new_node_file = open(f'{model_data_folder}/{node_file}','w', encoding='utf-8')
    with open(f'{ori_data_folder}/{node_file}','r', encoding='utf-8') as original_node_file:
        for line in original_node_file:
            if line.startswith('id'): continue
    ...
    print(f'TED: converting {dataset}\'s link file!')
    new_link_file = open(f'{model_data_folder}/{link_file}','w', encoding='utf-8')
    with open(f'{ori_data_folder}/{link_file}','r', encoding='utf-8') as original_link_file:
        for line in original_link_file:
            if line.startswith('source_id'): continue
    ...
    print(f'TED: writing {dataset}\'s config file!') 
    target_node, target_edge, ltypes = 0, 0, []
    with open(f'{ori_data_folder}/{info_file}','r', encoding='utf-8') as original_info_file:
        for line in original_info_file:
            if line.startswith('Targeting: Link Type'): target_edge = int(line[:-2].split(',')[-1])
    ...
    if supervised=='True':
        print(f'TED: converting {dataset}\'s label file for semi-supervised training!')
        if dataset == 'T20H' or dataset == 'T15H':
            for i in range(5):
                label_file = 'label_TaxPayer' + str(5-i) + 'v' + str(5+i) + '.dat'
                new_label_file = open(f'{model_data_folder}/{label_file}','w', encoding='utf-8')
